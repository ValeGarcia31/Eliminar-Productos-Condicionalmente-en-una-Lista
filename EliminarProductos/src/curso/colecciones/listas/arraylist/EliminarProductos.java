...
*identificados en una lista, sin embargo, en su base de datos siguen aparciendo
...
*si esas prendas se ecnuentran en la base de datos y, si es el caso que se eliminen.
 */
...
public class EliminarProductos {
        ...
        public static Producto[] obtenerProductos(){
            Producto[] productos = {
                new Producto("HGM", "Gris", "Pay", "32L"),
                new Producto("HGM", "Verde", "Pay", "32L"),
      ...
      //eliminarMarcasStream(productos, Arrays.asList(marcas));
       ...
       private static void eliminarMarcasIterator(List<Producto> productos, List<String> marcas){
        ...
        //Código con programación funcional opción#2
